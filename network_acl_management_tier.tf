...
resource "aws_network_acl_rule" "management_all_ingress_from_cidr_blocks" {
    ...
    protocol = "-1"
    rule_number = "${100
    + (10 * length(local.network_acl_management_ssh_ingress_from_cidr_blocks))
    + (10 * count.index)}"
    rule_action = "allow"
...
resource "aws_network_acl_rule" "management_ephemeral_ingress_from_cidr_blocks" {
    ...
    rule_number = "${100
    + (10 * length(local.network_acl_management_ssh_ingress_from_cidr_blocks))
    + (10 * length(local.network_acl_management_all_ingress_from_cidr_blocks))
    + (10 * count.index)}"
    rule_action = "allow"
...
resource "aws_network_acl_rule" "management_all_egress_to_cidr_blocks" {
    ...
    protocol = "-1"
    rule_number = "${100
    + (10 * length(local.network_acl_management_ssh_egress_to_cidr_blocks))
    + (10 * count.index)}"
    rule_action = "allow"
...
resource "aws_network_acl_rule" "management_ephemeral_egress_from_cidr_blocks" {
    ...
    rule_number = "${100
    + (10 * length(local.network_acl_management_ssh_egress_to_cidr_blocks))
    + (10 * length(local.network_acl_management_all_egress_to_cidr_blocks))
    + (10 * count.index)}"
    rule_action = "allow"
